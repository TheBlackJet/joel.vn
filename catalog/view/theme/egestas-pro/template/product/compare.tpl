	...
	<div class="box">
		...
		<table class="list compare-info">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php if ($product['thumb']) { ?>
						...
						<?php } ?>
						<?php } else { ?>
						<span class="no-image"><img src="image/no_image.jpg" alt="<?php echo $products[$product['product_id']]['name']; ?>" /></span>
						<?php } ?></td>
					<?php } ?>
				</tr>
				<tr>
				...
				<tr>
					...
					<?php foreach ($products as $product) { ?>
					<td><img src="catalog/view/theme/egestas-pro/image/icons/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
			...
			<tr>
				<td></td>
				<?php foreach ($products as $product) { ?>
				<td><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><span class="icon-cart-white"><?php echo $button_cart; ?></span></a></td>
				<?php } ?>
			</tr>
			<tr>
				<td></td>
				<?php foreach ($products as $product) { ?>
				<td class="remove"><a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/egestas-pro/image/icons/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
				<?php } ?>
			</tr>
		</table>
		<div class="buttons">
