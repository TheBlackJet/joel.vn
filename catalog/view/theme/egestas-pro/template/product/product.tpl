	...
	<div class="box">
		...
		<div class="product-info">
			...
			<div class="right" style="margin-left: <?php echo $this->config->get('config_image_thumb_width') + 52 ?>px;">
				...
				<div class="review"> <img src="catalog/view/theme/egestas-pro/image/icons/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><a class="show-review" href="#tabs"><?php echo $reviews; ?></a> <a class="new-review" href="#tabs"><?php echo $text_write; ?></a> </div>
				<?php } ?>
				<?php if ($price) { ?>
				<div class="price">
					<?php if (!$special) { ?>
				...
				<div class="cart">
					<div>
						<button class="button" id="button-cart"><span class="icon-cart-white"><?php echo $button_cart; ?></span></button>
					</div>
...
?>
<link rel="stylesheet" href="catalog/view/theme/egestas-pro/stylesheet/jqzoom.css" />
<script type="text/javascript" src="catalog/view/theme/egestas-pro/js/jqzoom.js"></script> 
<script type="text/javascript">
