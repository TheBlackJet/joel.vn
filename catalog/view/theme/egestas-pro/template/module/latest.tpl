<?php
	$option = $this->config->get('latest_module');
		...
		<div class="box-product product-grid">
			...
			<div>
				...
				<div class="details">
					...
					<div class="wishlist"><a onclick="addToWishList('<?php echo $product['product_id']; ?>');"><span class="icon-wishlist-grey">Add to Wishlist</span></a></div>
					<div class="compare"><a onclick="addToCompare('<?php echo $product['product_id']; ?>');"><span class="icon-compare-grey">Add to Compare</span></a></div>
				</div>
			</div>
			<?php } ?>
		</div>
